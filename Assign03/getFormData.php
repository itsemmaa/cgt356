...
} //cant access this page without entering info

//grab info from billing (left side)
$name = $_POST["name"];
...
//if shipping is empty, use same information for shipping
if( empty($_POST["Sname"]) ) {
	...
	//if presented seperate shipping info, grab that
	$Sname = $_POST["Sname"];
...
<head>
	<meta charset="utf-8" />
	<title>Assign03 - getFormData Page</title>
	<style type="text/css">
...
<body>
<h1 style="font-size:14pt; text-indent:360px;">Assign03 - getFormData Page</h1>
	
<form id="form0" method="post" action="displayFormData.php">
	<fieldset id="billing">
		<legend>Billing Information</legend>
		<ul>
			<li> <label title="Name" for="name">Name <span>*</span></label> <input type="text" name="name" id="name" size="30" maxlength="30" value="<?php echo($name);?>" /></li> <!-- use php to autopopulate all values to next form -->
	...
	<fieldset id="shipping">
		...
		<ul>
			...
			<li> <label title="SCountry" for="Scountry">Country </label> <input type="text" name="Scountry" size="30" maxlength="30" value="<?php echo($Scountry);?>" /></li>
		</ul>
	</fieldset>
	<fieldset id="submit">
