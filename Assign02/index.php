...
<head>
	...
	<style type="text/css">
		...
		ul li input{ float: right; margin-right: 10px; border: 1px solid #ccc; padding: 3px; font-family: Georgia, Times New Roman, Times, serif; width: 60%}
...
<body>
<h1 style="font-size: 14pt; text-indent: 360px;">Assign02 - Index</h1>
	
<form id="form0" action="login.php" method="post">
	<fieldset id="info">
		<legend>Login</legend>
		<ul>
			<li> <label title="userID">UserID <span>*</span></label> <input type="text" name="userID" id="userID" size="30" maxlength="30" /></li>
			<li> <label title="passwd">Password <span>*</span></label> <input type="password" name="passwd" id="passwd" size="30" maxlength="30" /></li>
		</ul>
	</fieldset>
	<fieldset id="submit">
